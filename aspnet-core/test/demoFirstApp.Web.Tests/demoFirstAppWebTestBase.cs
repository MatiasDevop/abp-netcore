...
using demoFirstApp.Models.TokenAuth;
...
{
    public abstract class demoFirstAppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static demoFirstAppWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(demoFirstAppWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<demoFirstAppDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<demoFirstAppDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<demoFirstAppDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<demoFirstAppDbContext, Task<T>> func)
        {
            T result;
